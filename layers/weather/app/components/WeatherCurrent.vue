...
<template>
  <div class="rounded-2xl border border-gray-400 dark:border-dark-700 bg-white dark:bg-dark-700 p-6">
    ...
    <template v-if="weather">
      <div
        class="flex items-center justify-center gap-4 pb-4 border-b border-gray-300 dark:border-dark-700 bg-gray-200 dark:bg-dark-800 rounded-xl p-4"
      >
        <img :src="weather.condition.iconUrl" :alt="weather.condition.description" class="h-14 w-14" >
        <div>
          <p class="text-4xl font-bold text-gray-900 dark:text-gray-100">{{ weather.temperature }}°C</p>
      ...
      <div class="mt-4 grid grid-cols-2 gap-2">
        <div v-for="stat in weatherStats" :key="stat.label" class="rounded-xl bg-gray-200 dark:bg-dark-800 p-3">
